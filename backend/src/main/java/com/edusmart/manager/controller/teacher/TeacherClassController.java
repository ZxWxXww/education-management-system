...
@PreAuthorize("hasRole('TEACHER') and hasAuthority('teacher:class:view')")
public class TeacherClassController {
    ...
    @PostMapping("/page")
    public Result<PageData<TeacherClassPageItemDTO>> page(@RequestBody TeacherClassPageQueryDTO queryDTO) { return Result.success(classService.page(queryDTO)); }
    @GetMapping("/{id}")
    public Result<TeacherClassDetailDTO> detail(@PathVariable Long id) { return Result.success(classService.getById(id)); }
    @PostMapping
