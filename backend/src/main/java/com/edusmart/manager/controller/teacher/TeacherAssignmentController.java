...
@PreAuthorize("hasRole('TEACHER') and hasAuthority('assignment:manage')")
public class TeacherAssignmentController {
    ...
    @PostMapping("/page")
    public Result<PageData<TeacherAssignmentPageItemDTO>> page(@RequestBody TeacherAssignmentPageQueryDTO queryDTO) { return Result.success(assignmentService.page(queryDTO)); }
    @GetMapping("/{id}")
    public Result<TeacherAssignmentPageItemDTO> detail(@PathVariable Long id) { return Result.success(assignmentService.getById(id)); }
    @PostMapping
