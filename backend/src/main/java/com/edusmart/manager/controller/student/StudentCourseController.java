...
@PreAuthorize("hasRole('STUDENT') and hasAuthority('student:class:view')")
public class StudentCourseController {
    ...
    @PostMapping("/page")
    public Result<PageData<StudentCoursePageItemDTO>> page(@RequestBody StudentCoursePageQueryDTO queryDTO) {
        return Result.success(courseService.pageCourses(queryDTO));
    }

    @GetMapping("/classes/{id}")
    public Result<StudentCourseDetailDTO> classDetail(@PathVariable Long id) {
