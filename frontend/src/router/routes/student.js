...
export default [
  {
    ...
    children: [
      ...
      { path: 'assignments/submissions', name: 'StudentHomeworkSubmissions', component: () => import('../../views/student/HomeworkSubmissions.vue'), meta: { role: 'student' } },
      { path: 'assignments/resources', name: 'StudentLearningResources', component: () => import('../../views/student/LearningResources.vue'), meta: { role: 'student' } },
